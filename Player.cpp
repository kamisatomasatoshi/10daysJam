...
void Player::LoadTexture() {
	texture = LoadGraph("Resource/blockTexture.png"); // プレイヤーのテクスチャ
	if (texture == -1) {
...
void Player::Draw() {
	...
	DrawFormatString(512, 0, GetColor(255, 255, 255), "重力%d", vy);
	DrawFormatString(512, 16, GetColor(255, 255, 255), "フラグ%d", playerFlag);
